...
pub const COL_CARD_BORDER_DISCARD: Color = COL_RED_LIGHT;
pub const COL_CARD_BORDER_DISCARD_HOVER: Color = COL_RED;
pub const COL_CARD_TEMP_COST_BG: Color = COL_PURPLE_DARKER;
pub const COL_CARD_TEMP_UP: Color = COL_RED_LIGHT;
...
pub const COL_CARD_EFFECT_MOVEMENT_HOVER: Color = COL_TURQUOISE_DARK;
pub const COL_CARD_EFFECT_ATTACK: Color = COL_ORANGE;
pub const COL_CARD_EFFECT_ATTACK_HOVER: Color = COL_RED;
